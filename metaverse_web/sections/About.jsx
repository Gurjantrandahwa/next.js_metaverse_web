...
const About = () => (
  ...
  >
    <div className="gradient-02 z-0"/>
      ...
      >
        <span className="font-extrabold tex-white">Metaverse{" "}</span>
       ...
       <span className="font-extrabold tex-white"> madness of the metaverse </span> 
        of today, using only
        <span className="font-extrabold tex-white"> VR </span>
        devices you can easily
        <span className="font-extrabold tex-white"> explore </span>
